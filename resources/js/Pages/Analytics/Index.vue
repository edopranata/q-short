        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-5 w-0 flex-1">
                                    <dl>
                                        ...
                                        <dd class="text-2xl font-bold text-gray-900">{{ stats.total_urls }}</dd>
                                    </dl>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-5 w-0 flex-1">
                                    <dl>
                                        ...
                                        <dd class="text-2xl font-bold text-gray-900">{{ stats.total_clicks.toLocaleString() }}</dd>
                                    </dl>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-5 w-0 flex-1">
                                    <dl>
                                        ...
                                        <dd class="text-2xl font-bold text-gray-900">{{ stats.clicks_today }}</dd>
                                    </dl>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-5 w-0 flex-1">
                                    <dl>
                                        ...
                                        <dd class="text-2xl font-bold text-gray-900">{{ stats.clicks_this_month }}</dd>
                                    </dl>
                                </div>
                            </div>
                        </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                    ...
                    <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                        <div class="p-6">
                            <h3 class="text-lg font-medium text-gray-900 mb-4">Top Performing URLs</h3>
                            <div class="space-y-4">
                                <div v-for="url in top_urls" :key="url.id" class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                    ...
                                    <div class="flex items-center gap-4">
                                        <div class="text-right">
                                            <p class="text-sm font-medium text-gray-900">{{ url.click_count }} clicks</p>
                                            <Link
                                ...
                                <div v-if="top_urls.length === 0" class="text-center py-8 text-gray-500">
                ...
                <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                    <div class="p-6">
                        <div class="flex justify-between items-center mb-6">
                            <h3 class="text-lg font-medium text-gray-900">Recent URLs</h3>
                            <Link
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <tr v-for="url in urls.data.slice(0, 5)" :key="url.id" class="hover:bg-gray-50">
                                        <td class="px-6 py-4">
                                            <div>
