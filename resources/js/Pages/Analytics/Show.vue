    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                            ...
                            <div>
                                ...
                                <dl class="space-y-3">
                                    <div>
                                        ...
                                        <dd class="mt-1 text-2xl font-bold text-gray-900">{{ total_clicks.toLocaleString() }}</dd>
                                    </div>
                                    <div>
                ...
                <div class="bg-white overflow-hidden shadow-sm rounded-lg mb-8">
                    <div class="p-6">
                        <h3 class="text-lg font-medium text-gray-900 mb-4">Daily Clicks (Last 30 Days)</h3>
                        <div class="h-64">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                            ...
                            <div class="space-y-3">
                                <div v-for="(count, browser) in analytics.browser_stats" :key="browser" class="flex items-center justify-between">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-sm text-gray-900">{{ browser || 'Unknown' }}</span>
                                    </div>
                                    <div class="flex items-center gap-2">
                                ...
                                <div v-if="Object.keys(analytics.browser_stats).length === 0" class="text-center py-4 text-gray-500">
                    ...
                    <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                        <div class="p-6">
                            <h3 class="text-lg font-medium text-gray-900 mb-4">Platforms</h3>
                            <div class="space-y-3">
                                <div v-for="(count, platform) in analytics.platform_stats" :key="platform" class="flex items-center justify-between">
                                    <div class="flex items-center gap-2">
                                        <div class="w-3 h-3 bg-green-500 rounded-full"></div>
                                        <span class="text-sm text-gray-900">{{ platform || 'Unknown' }}</span>
                                    </div>
                                    <div class="flex items-center gap-2">
                                        <span class="text-sm font-medium text-gray-900">{{ count }}</span>
                                        <span class="text-xs text-gray-500">
                                ...
                                <div v-if="Object.keys(analytics.platform_stats).length === 0" class="text-center py-4 text-gray-500">
                            ...
                            <div class="space-y-3">
                                <div v-for="(count, device) in analytics.device_stats" :key="device" class="flex items-center justify-between">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-sm text-gray-900 capitalize">{{ device || 'Unknown' }}</span>
                                    </div>
                                    <div class="flex items-center gap-2">
                                        <span class="text-sm font-medium text-gray-900">{{ count }}</span>
                                        <span class="text-xs text-gray-500">
                                ...
                                <div v-if="Object.keys(analytics.device_stats).length === 0" class="text-center py-4 text-gray-500">
                    ...
                    <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                        <div class="p-6">
                            ...
                            <div class="space-y-3">
                                <div v-for="(count, country) in analytics.country_stats" :key="country" class="flex items-center justify-between">
                                    <div class="flex items-center gap-2">
                                        <div class="w-3 h-3 bg-yellow-500 rounded-full"></div>
                                        <span class="text-sm text-gray-900">{{ getCountryName(country) }}</span>
                                    </div>
                                    <div class="flex items-center gap-2">
                                        <span class="text-sm font-medium text-gray-900">{{ count }}</span>
                                        <span class="text-xs text-gray-500">
                                ...
                                <div v-if="Object.keys(analytics.country_stats).length === 0" class="text-center py-4 text-gray-500">
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <tr v-for="(count, referrer) in analytics.referrer_stats" :key="referrer">
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                            <a v-if="referrer && referrer !== 'null'" :href="referrer" target="_blank" class="text-blue-600 hover:text-blue-800 break-all">
                                                {{ referrer }}
                                            </a>
                            ...
                            <div v-if="Object.keys(analytics.referrer_stats).length === 0" class="text-center py-8 text-gray-500">
...
const initChart = async () => {
    ...
    // Prepare data
    const data = Object.entries(props.analytics.daily_clicks || {}).map(([date, clicks]) => ({
        date,
        clicks
